...
RUN eclipse/eclipse -application org.eclipse.equinox.p2.director -noSplash -installIU ilg.gnuarmeclipse.core,ilg.gnuarmeclipse.managedbuild.cross.feature.group
